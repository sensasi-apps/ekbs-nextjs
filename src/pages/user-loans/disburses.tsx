...
export default function UserLoansDisburses() {
    ...
    const [formData, setFormData] = useState(UserLoanDisburseFormInitialValues)
    ...
    const handleSubmit: FormikConfig<typeof formData>['onSubmit'] = (
        values,
        { setErrors },
    ) => {
        ...
        return axios
            .post(`user-loans/${userLoan.uuid}/disburse`, values)
            .then(() => {
                mutate()
                handleClose()
            })
