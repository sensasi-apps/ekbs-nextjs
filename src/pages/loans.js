...
import { Button, FormControl, FormControlLabel, FormLabel, Radio, RadioGroup, Select, TextField } from '@mui/material'
        ...
        <AppLayout
            ...
            <form onSubmit={findLoan}>
                ...
                <FormControl>
                    ...
                    <RadioGroup row>
                        <FormControlLabel value="date" control={<Radio />} label="Tanggal" checked />
                        <FormControlLabel value="user_id" control={<Radio />} label="Pengguna" />
                        <FormControlLabel value="loan_id" control={<Radio />} label="Nomor" />
                    </RadioGroup>
                </FormControl>
                <TextField label="Tanggal" fullWidth type='date' />
                {/* <Select></Select> */}
                <TextField label="Nomor Pinjaman" fullWidth name="loan_id" type="number" />
